...
//              $updateqry="DELETE FROM `multiple-images` WHERE email='$email'";
//              $query_run =mysqli_query($con,$updateqry);

//    //insert images
//             $insertqry="INSERT INTO `multiple-images`( `image`,`image1`,`image2`,`l_id`, `image_createtime`) VALUES ('$finalimg','$l_id','$creattime')";
