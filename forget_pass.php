...
if(isset($_POST['submit'])) {
    ...
    while($row = $result->fetch_assoc()){
        ...
        $link = "<a href='reset.php?MnoQtyPXZORTE=$id_encode' class='btn btn-info btn-sm'>Change</a>";
    }
    }else{
...
<body  class="bg-white">
        <div class="container w-50 mt-5">
            <form class="bg-light p-5 shadow-lg" method="post">
                ...
                <input type="email" name="username" placeholder="Email Address" class="form-control form-control-sm" required><br>
